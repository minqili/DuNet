...
if __name__ == '__main__':
    model_name = 'u2net_bce_itr_50000_train_0.004185_tar_0.000124'  # 'u2net'#u2netp

    if (model_name == 'u2net_bce_itr_50000_train_0.004185_tar_0.000124'):  # u2net
        print("...load u2net_bce_itr_52000_train_0.004943_tar_0.000279---168 MB")
        net = U2NET(3, 1).to(device=0)

    #net = U2NET().cuda()
    # net = net().cuda()
    flops, params = get_model_complexity_info(net, (3, 320, 320), as_strings=False, print_per_layer_stat=True)
