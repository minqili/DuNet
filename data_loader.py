...
class SalObjDataset(Dataset):
    # def __init__(self, img_name_list, lbl_name_list, transform=None, memory_bank=None):
    def __init__(self, img_name_list, lbl_name_list, transform=None):
        ...
        # ########
        # self.memory_bank = memory_bank  # 将MemoryBank实例传递给数据集类
        # ###########
    ...
    def __getitem__(self, idx):
        ...
        # # 将标签传递给MemoryBank
        # if self.memory_bank:
        #     self.memory_bank.load_label(label)
